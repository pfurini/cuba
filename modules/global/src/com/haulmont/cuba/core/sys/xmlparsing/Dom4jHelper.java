 ...
 */
@Component(Dom4jHelper.NAME)
public class Dom4jHelper {

    public static final String NAME = "cuba_Dom4jHelper";

    protected Dom4jHelperConfig config;
     ...
     */
    @Inject
    public Dom4jHelper(GlobalConfig globalConfig, Dom4jHelperConfig config) {
    ...
    protected void initPool() {
        ...
        String jmxName = "dom4JHelper-" + globalConfig.getWebContextName();
